function SearchHeaderBar({ queryInput = '', onQueryInputChange, onSubmit }) {
  return (
    <div className="search-header-bar sticky bg-deepOcean top-0 z-40 shadow-md isolate">
        ...
        <form method="get" action="/search/" id="header-search-form" onSubmit={onSubmit}>
          <div className="relative flex-grow">
            <input
              ...
              className="w-full bg-white pl-10 pr-4 py-3 border border-gray-300 text-coolSage placeholder-coolSage rounded-[9px] focus:outline-none focus:ring-2 focus:ring-coolSage focus:border-transparent text-sm"
