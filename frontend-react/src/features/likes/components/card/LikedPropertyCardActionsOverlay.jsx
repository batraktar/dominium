import LikedPropertyShareMenu from './LikedPropertyShareMenu.jsx'

function LikedPropertyCardActionsOverlay({
  property,
  isLiked = false,
  userIsStaff = false,
...
export default LikedPropertyCardActionsOverlay
